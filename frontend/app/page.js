      ...
      <div className="main-layout">
        ...
        <footer className="main-footer hero-enter-5">
          ...
          <div className="footer-right" style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
            ...
            <a href="https://www.linkedin.com/company/aims-dtu/posts/?feedView=all" target="_blank" rel="noopener noreferrer"
               style={{ display: "flex", alignItems: "center", gap: "0.25rem" }}>
            ...
            <a href="https://www.instagram.com/aimsdtu/?hl=en" target="_blank" rel="noopener noreferrer"
               style={{ display: "flex", alignItems: "center", gap: "0.25rem" }}>
              <svg style={{ width: "16px", height: "16px", fill: "currentColor" }} viewBox="0 0 24 24">
