const extractedRecords = [
  ...
  {
    tag: "BITS Apogee 2026",
    title: "1st & 2nd: Silicon Chip Smackdown",
    meta: "Bibek Sanjeev, Faaiz Hussain, Shaurya Suyal, Aarush Mahajan, Aaarat Chadda",
    desc: "Podium finishes in the AI Poker agent simulation smackdown.",
  },
  {
    tag: "BITS Apogee 2026",
  ...
  },
  {
    ...
    meta: "Divya Jassal, Garv Saluja et al.",
  ...
  {
    tag: "IIT Bombay Techfest 2025",
    title: "1st & 3rd: National GeoAI Hackathon",
    meta: "1st: Sparsh Jain et al. | 3rd: Ishan Chugh et al.",
    desc: "Satellite imagery processing for multispectral land classification.",
  },
];
        ...
        {extractedRecords.map((record, index) => (
          <div key={index} className="showcase-image-wrapper" style={{ aspectRatio: "1 / 1" }}>
            <div className="placeholder-bg" style={{ background: "linear-gradient(45deg, #0f0f14 0%, #15151b 100%)" }}>
              <span className="text-[10px] text-[var(--muted)] font-mono uppercase tracking-wider">{record.tag}</span>
            </div>
